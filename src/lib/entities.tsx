...
export const vendorsConfig: EntityConfig<"vendors"> = {
  ...
  singular: "Vendor",
  plural: "Vendors",
  description: "Carriers, CHAs, truckers and warehouses you transact with.",
  codePrefix: { field: "code", prefix: "VEN-", pad: 4 },
  columns: [
  ...
  fields: [
    ...
    { name: "name", label: "Name", type: "text", required: true },
    {
      ...
      type: "select",
      required: true,
      options: ["Shipping Line", "CHA", "Trucker", "Warehouse", "Other"],
    ...
    { name: "email", label: "Email", type: "text", email: true },
...
export const importJobsConfig: EntityConfig<"importJobs"> = {
  ...
  hint: "Generated by server",
    ...
    { name: "blDate", label: "BL Date", type: "date", required: true },
...
export const importChecklistsConfig: EntityConfig<"importChecklists"> = {
  ...
  fields: [
    ...
    { name: "checklist", label: "Checklist", type: "select", options: PD, default: "Pending", required: true },
    // { name: "igm", label: "IGM", type: "date", required: true },
    { name: "igmDate", label: "IGM Date", type: "date", required: true },
    { name: "igmStatus", label: "IGM Status", type: "select", options: PD, default: "Pending", required: true },
    ...
    { name: "goodsRegi", label: "Goods Regi", type: "select", options: PD, default: "Pending", required: true },
    { name: "otherGovAgency", label: "Other Gov Agency", type: "select", options: YN, required: true },
    { name: "otherGovAgencyType", label: "Type of Other Gov Agency", type: "services", options: ["FSSAI", "PPQ", "CDRUG", "Other"], serviceStatusOptions: PD, showWhen: { field: "otherGovAgency", equals: "Yes" }, required: true, colSpan: 3 },
    { name: "assessmentType", label: "Assessment Type", type: "select", options: ["RMS", "APR"], required: true },
    { name: "cfsName", label: "CFS Name", type: "select", options: ["Hind Terminal", "Ashutosh", "Hind Terminal2", "Landmark", "Seabird", "Ameya", "Allcargo", "Speedy", "Mundhra", "Saurashtra", "Transworld1", "Transworld2"], creatable: true, showWhen: { field: "assessmentType", equals: "APR" }, required: true },
    { name: "boeCopyMailed", label: "BOE Copy Mailed", type: "select", options: PD, default: "Pending", required: true },
    { name: "document", label: "Document", type: "select", options: PD, default: "Pending", required: true },
    { name: "coDefaceRequired", label: "CO Deface Required", type: "select", options: YN, required: true },
    { name: "coDeface", label: "CO Deface", type: "select", options: PD, default: "Pending", showWhen: { field: "coDefaceRequired", equals: "Yes" }, required: true },
    { name: "dutyPayment", label: "Duty Payment", type: "select", options: PD, default: "Pending", required: true },
    { name: "ooc", label: "OOC", type: "select", options: PD, default: "Pending", required: true },
    { name: "ocMail", label: "OC Mail", type: "select", options: PD, default: "Pending", required: true },
    { name: "linerInvoice", label: "Liner Invoice", type: "select", options: PD, default: "Pending", required: true },
    { name: "linerPayment", label: "Liner Payment", type: "select", options: PD, default: "Pending", required: true },
    { name: "paymentConfirm", label: "Payment Confirm", type: "select", options: PD, default: "Pending", required: true },
    { name: "doDocs", label: "DO Docs", type: "select", options: PD, default: "Pending", required: true },
    { name: "doReceived", label: "DO Received", type: "select", options: PD, default: "Pending", required: true },
    { name: "doValidity", label: "DO Validity", type: "date", required: true, showWhen: { field: "doReceived", equals: "Done" } },
    { name: "doType", label: "DO Type", type: "select", options: ["Factory", "Doc destuff"], required: true, showWhen: { field: "doReceived", equals: "Done" } },
    { name: "doProcess", label: "DO Process", type: "select", options: ["Mundra", "Gandhidham", "Party"], required: true },
    { name: "stampDuty", label: "Stamp Duty", type: "select", options: PD, default: "Pending", required: true },
    { name: "transportation", label: "Transportation", type: "select", options: ["Octopus", "Party"], required: true },
    { name: "transporter", label: "Transporter", type: "select", options: ["Bansal", "Sai Logistics", "Chamunda"], creatable: true, showWhen: { field: "transportation", equals: "Octopus" }, required: true },
    { name: "performaInvoice", label: "Performa Invoice", type: "select", options: PD, default: "Pending", required: true },
    { name: "cfsPayment", label: "CFS Payment", type: "select", options: PD, default: "Pending", required: true },
    ...
    { name: "delivery", label: "Delivery", type: "select", options: PD, default: "Pending", required: true },
    { name: "vendorInvoices", label: "Vendor Invoices", type: "select", options: PD, default: "Pending", required: true },
  ],
};
